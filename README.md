...
[![All the technologies I have worked with:](https://skillicons.dev/icons?i=rust,java,python,html,css,js,php,flask,git,eclipse,vscode,zed,sql,bootstrap,docker,linux,blender,arduino)](https://skillicons.dev)
