...
[![All the technologies I have worked with:](https://skillicons.dev/icons?i=rust,java,python,cs,html,css,js,php,flask,git,eclipse,vscode,mysql,bootstrap,docker,linux,blender,arduino)](https://skillicons.dev)
